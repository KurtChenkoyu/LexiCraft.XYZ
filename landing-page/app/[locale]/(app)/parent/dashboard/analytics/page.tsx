 ...
 * 
 * Deep dive into learning metrics and performance.
 * Content migrated from coach-dashboard/page.tsx
 * 
 * URL: /parent/dashboard/analytics
 */

// Default dashboard state - show UI immediately, never block
const defaultDashboard: CoachDashboard = {
  learner_id: '',
  overview: {
    level: 1,
    total_xp: 0,
...
export default function AnalyticsPage() {
  ...
  const [dashboard, setDashboard] = useState<CoachDashboard>(defaultDashboard)
  ...
  useEffect(() => {
    ...
    const fetchDashboard = async () => {
      try {
        ...
        setIsOffline(true)
        // Keep default state, don't show error page
      }
    }
  ...
  // No children state - show empty state but still render UI
    ...
    <>
      ...
      {hasNoChildren ? (
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">請先在孩子管理中新增孩子</p>
          <Link
        ...
        <>
          {/* Dashboard Content - Always render, even with default data */}
          <>
            {/* Overview Stats */}
