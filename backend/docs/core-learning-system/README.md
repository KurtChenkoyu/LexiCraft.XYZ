...
**Note:** This directory should be renamed from `core-learning-system/` to `core-verification-system/` for consistency with the verification/solidification terminology.
