...
### Purpose
Guides users through the vocabulary learning journey, from initial discovery to mastery.

### Key Features
- **Word Discovery**: Survey system to identify known words
- **Learning Progression**: Tier-based learning (Tier 0 → Tier 5)
...
- `backend/src/api/analytics.py` - Learning analytics
